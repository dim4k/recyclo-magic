    ...
    return (
        <html lang="fr">
            <body
                ...
                className="antialiased min-h-screen flex justify-center bg-gray-900"
                style={{
                    backgroundImage:
                        "url('https://images.unsplash.com/photo-1542273917363-3b1817f69a5d?q=80&w=1080&auto=format&fit=crop')",
